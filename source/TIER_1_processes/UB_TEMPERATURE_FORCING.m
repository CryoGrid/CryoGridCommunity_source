...
classdef UB_TEMPERATURE_FORCING < BASE
    ...
    methods
        ...
        function ground = get_boundary_condition_u(ground, forcing)
            ...
            % temperature forcing.
            ground.TEMP.F_ub = -(forcing.TEMP.Tair - ground.STATVAR.T(1)).*ground.STATVAR.thermCond(1)./(ground.STATVAR.layerThick(1)/2); 
            ground.TEMP.d_energy(1) = ground.TEMP.d_energy(1) - ground.TEMP.F_ub.*ground.STATVAR.area(1);
        end        
