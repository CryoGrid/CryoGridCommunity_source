...
classdef GROUND_ESA_CCI < BASE
    ...
    methods
        ...
        function ground = finalize_init(ground, tile)
            ...
            ground.TEMP.F_lb = repmat(tile.PARA.geothermal', 1, tile.ENSEMBLE.PARA.ensemble_size);
...
%             %rho_snow = max(50, a + b.*T + (c.*PROFILE.wind_speed20.^0.5)); %using 20m height wind so that snow density is not influenced by forest canopy
            ...
            rho_wind = 266.861.*(0.5.*(1+tanh(tile.ENSEMBLE.STATVAR.wind_speed_class./5))).^8.8;
