...
classdef OUT_preproc < matlab.mixin.Copyable
...
% 			out.OUTPUT_TIME = forcing.PARA.start_time + out.PARA.output_timestep;
        ...
        function out = store_OUT(out, tile)          
            ...
            if tile.t  >= out.SAVE_TIME
                ...
                filename=[out.PARA.output_path tile.RUN_INFO.PARA.run_name '/' tile.RUN_INFO.PARA.run_name '_' variable '_' datestr(out.START_SAVE_INTERVAL, 'yyyymmdd') '_' datestr(tile.t, 'yyyymmdd') '.nc'];
