...
%                 stratigraphy1.STATVAR.vegetation.mlcanopyinst.etsoi = (0.0181528 .* stratigraphy1.STATVAR.vegetation.mlcanopyinst.etsoi)./1000;
            ...
            elseif stratigraphy1.IA_CHILD.STATUS == 2 %non-zero SWE, but snow is still a child
                ...
                stratigraphy2 = get_boundary_condition_u_CHILD(stratigraphy2, forcing); %call the native function for the snow class
...
%                 stratigraphy1.STATVAR.vegetation.mlcanopyinst.etsoi = (0.0181528 .* stratigraphy1.STATVAR.vegetation.mlcanopyinst.etsoi)./1000;
                ...
                % Simone: Set ground.STATVAR.vegetation.soilvar.t_soisno to actual CG soil temperature
                stratigraphy1.STATVAR.vegetation.soilvar.t_soisno(1) = interp1(stratigraphy1.STATVAR.midPoint,stratigraphy1.STATVAR.T+273.15,stratigraphy1.STATVAR.vegetation.soilvar.zi(1),'nearest');
                stratigraphy1.STATVAR.vegetation.soilvar.t_soisno(2) = interp1(stratigraphy1.STATVAR.midPoint,stratigraphy1.STATVAR.T+273.15,stratigraphy1.STATVAR.vegetation.soilvar.zi(2),'nearest');
                stratigraphy1.STATVAR.vegetation.soilvar.t_soisno(3) = interp1(stratigraphy1.STATVAR.midPoint,stratigraphy1.STATVAR.T+273.15,stratigraphy1.STATVAR.vegetation.soilvar.zi(3),'nearest'); 
