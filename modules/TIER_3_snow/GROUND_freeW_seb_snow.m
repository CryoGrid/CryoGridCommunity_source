       ...
       %-------------------
        ...
        function ground = get_boundary_condition_u(ground, forcing)
            ...
            if ground.CHILD == 0  %CHILD does not exist
                ground = get_boundary_condition_u@GROUND_freeW_seb(ground, forcing); %call the native function for the ground class
        ...
        function timestep = get_timestep(ground) 
            if ground.CHILD == 0
                ...
                timestep_ground =  get_timestep@GROUND_freeW_seb(ground);
