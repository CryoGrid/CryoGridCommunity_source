...
classdef GROUND_freezeC_bucketW_Xice_seb_snow < GROUND_freezeC_bucketW_Xice_seb
    ...
    methods
        ...
        function self = GROUND_freezeC_bucketW_Xice_seb_snow(index, pprovider, cprovider, forcing)
            self@GROUND_freezeC_bucketW_Xice_seb(index, pprovider, cprovider, forcing);
        end
