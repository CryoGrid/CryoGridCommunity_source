classdef DEM_gmted < matlab.mixin.Copyable
    ...
    methods
        ...
        function altitudes = get_altitudes(dem, run_info)
            ...
            minLat=min(run_info.STATVAR.latitude);
            maxLat=max(run_info.STATVAR.latitude);
            minLong=min(run_info.STATVAR.longitude);
            maxLong=max(run_info.STATVAR.longitude);
            ...
            altitudes = interp2(DEM_latitudes', DEM_longitudes', DEM', run_info.STATVAR.latitude, run_info.STATVAR.longitude, 'cubic');
