...
classdef OUT_preproc_save_with_offset_SEB < matlab.mixin.Copyable
...
%             if tile.t  >= out.SAVE_TIME
            ...
            filename=[out.PARA.output_path tile.RUN_INFO.PARA.run_name '/' tile.RUN_INFO.PARA.run_name '_' variable '_' start_save_string '.nc'];
            if ~(exist(filename)==2)
