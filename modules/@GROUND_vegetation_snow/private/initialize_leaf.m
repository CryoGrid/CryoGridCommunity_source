...
ground.STATVAR.vegetation.leaf.rhol(ivis) = 0.10;
ground.STATVAR.vegetation.leaf.taul(ivis) = 0.10;
ground.STATVAR.vegetation.leaf.rhol(inir) = 0.40;
ground.STATVAR.vegetation.leaf.taul(inir) = 0.40;
