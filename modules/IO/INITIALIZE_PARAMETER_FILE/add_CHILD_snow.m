...
for i=1:size(class_list,1)  %find snow in the class list
    if isprop(class_stratigraphy, 'snow_class') && ~isempty(class_stratigraphy.snow_class) && ...
            strcmp(class(class_list{i,1}), class_stratigraphy.snow_class.name) && ... 
            class_list{i,2} == class_stratigraphy.snow_class.index
