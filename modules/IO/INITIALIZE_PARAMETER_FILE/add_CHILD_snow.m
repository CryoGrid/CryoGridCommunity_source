...
elseif strcmp(class(ground), 'GROUND_fcSimple_salt_seb_snow_test') && strcmp(class(snow), 'SNOW_simple_seb')
    ground.IA_CHILD = IA_SNOW_GROUND_crocus_SW(); 
elseif strcmp(class(ground), 'GROUND_freezeC_bucketW_seb_snow') && strcmp(class(snow), 'SNOW_crocus')
    ground.IA_CHILD = IA_SNOW_GROUND_crocus_SW();
elseif strcmp(class(ground), 'GROUND_fcSimple_salt_seb_snow_test') && strcmp(class(snow), 'SNOW_crocus')
    ground.IA_CHILD = IA_SNOW_GROUND_crocus_SW();
end
