...
% CHANGE JOASC: 
% The forcing file name is now extracted from the configuration file 
% using a dedicatedd function from the parameter provider (it implies that 
% pprovider should be instantiated first). The name of the forcing file is
% compared to the list of files located in the folder forcing (this part 
...
tile = TILE_BUILDER(pprovider, cprovider, fprovider, ...
                           'forcing_id', pprovider.config_data.TILE_IDENTIFICATION.forcing_id, ...
                           'grid_id', pprovider.config_data.TILE_IDENTIFICATION.grid_id, ...
                           'out_id', pprovider.config_data.TILE_IDENTIFICATION.out_id, ...
                           'strat_linear_id', pprovider.config_data.TILE_IDENTIFICATION.strat_linear_id, ...
                           'strat_layers_id', pprovider.config_data.TILE_IDENTIFICATION.strat_layers_id, ...
                           'strat_classes_id', pprovider.config_data.TILE_IDENTIFICATION.strat_classes_id);
